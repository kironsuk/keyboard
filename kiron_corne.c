...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[2] = LAYOUT_split_3x6_3(KC_TRNS, KC_GRV, KC_TILD, KC_BSLS, KC_PIPE, KC_SLSH, KC_PCMM, KC_MINS, KC_EQL, KC_LPRN, KC_RPRN, KC_BSPC, KC_TRNS, MT(MOD_LSFT, KC_EXCLAIM), MT(MOD_LCTL, KC_AT), MT(MOD_LALT, KC_HASH), MT(MOD_LGUI, KC_DOLLAR), KC_PERC, KC_CIRC, MT(MOD_RGUI, KC_AMPERSAND), MT(MOD_RALT, KC_ASTERISK), MT(MOD_RCTL, KC_LEFT_BRACKET), MT(MOD_RSFT, KC_RIGHT_BRACKET), KC_TRNS, KC_TRNS, KC_TILD, KC_NO, KC_NO, KC_NO, KC_NO, KC_GRV, KC_UNDS, KC_PLUS, KC_LCBR, KC_RCBR, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
